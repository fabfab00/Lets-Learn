...
--%>
    <div><img style="width: 552px;height: 302px;margin-bottom: 78px;" src="<%=scriviLaparolaCorretta.getImage()%>" />
        <form style="align-content: center;">
            <div style="width: 40%;align-self: center;position: relative;left: 30%;font-size: 40px;"><label class="form-label">Che cos'<span>&#232</span>?</label><label class="form-control text-center"  style="font-size: 40px;"/><%=scriviLaparolaCorretta.getWord()%></div>
        </form>
    </div>
