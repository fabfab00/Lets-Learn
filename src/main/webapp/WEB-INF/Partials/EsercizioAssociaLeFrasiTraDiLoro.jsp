...
<div class="pageContenent">
    <div class="contenitoreTitoloSezione" style="z-index: 2;position: relative;">
        <i onclick="riproduciAudio('Associa Le Frasi Tra Di Loro',this)" style="z-index: 111;"> <%@include file="/Immagini/Sound.svg"%></i>
                    ...
                    <li>
                        <div class="float-start" style="width: 50%;">
                            <div class="colonna-frasi colonna-sinistra" onclick="select(this)"><input id="1" class="invisible-checkbox" type="checkbox" />
                                <div><i > <%@include file="/Immagini/UndoRubber.svg"%></i></div><span><%=associaLeFrasiTraDiloro.getList1().get(0)%></span>
                            </div>
                        </div>
                        <div class="float-start" style="width: 50%;">
                            <div class="colonna-frasi colonna-destra" onclick="select(this)"><input id="2" class="invisible-checkbox" type="checkbox" onclick="select(this)" />
                                <div><i > <%@include file="/Immagini/UndoRubber.svg"%></i></div><span><%=associaLeFrasiTraDiloro.getList2().get(0)%></span>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="float-start" style="width: 50%;">
                            <div class="colonna-frasi colonna-sinistra" onclick="select(this)"><input id="3" class="invisible-checkbox" type="checkbox" />
                                <div><i > <%@include file="/Immagini/UndoRubber.svg"%></i></div><span><%=associaLeFrasiTraDiloro.getList1().get(1)%></span>
                            </div>
                        </div>
                        <div class="float-start" style="width: 50%;">
                            <div class="colonna-frasi colonna-destra" onclick="select(this)"><input id="4" class="invisible-checkbox" type="checkbox" onclick="select(this)" />
                                <div><i > <%@include file="/Immagini/UndoRubber.svg"%></i></div><span><%=associaLeFrasiTraDiloro.getList2().get(1)%></span>
                            </div>
                        </div>
                    </li>
                </ul>
